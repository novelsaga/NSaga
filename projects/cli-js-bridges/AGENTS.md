...
## Generated Type Files Location

Generated TypeScript type files (from Rust via ts-rs) are now located at:

- `projects/cli-js-bridges/config-bridge/src/types/_config.ts` (auto-generated)

This file is automatically generated by the `xtask build-js` command and contains type definitions exported from the Rust core library.
